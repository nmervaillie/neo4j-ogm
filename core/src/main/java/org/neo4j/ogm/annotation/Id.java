 ...
 *
 * When using an @Id on a class attribute, this attribute will be considered as the key of the entity,
 ...
 *
 * This comes as a more explicit replacement to the old {@link Index}(primary = true, unique = true) annotation.
 *
 * @since 3.0
 * @author Mark Angrish
 */
